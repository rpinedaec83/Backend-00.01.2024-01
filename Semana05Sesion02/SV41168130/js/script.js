      ...
      Swal.fire({
        ...
        <div class="form-group">
            <label for="fechaNacimiento">Fecha de Nacimiento</label>
                <div class="input-group">
                <input type="date" class="form-control" id="fechaNacimiento" name="descripcion" placeholder="Ingrese la fecha de nacimiento"/>
            </div>
        </div>
        ...
        <div class="form-group">
            <label for="username">Sexo</label>
                <div class="input-group">                   
                    <input type="text" class="form-control" id="sexo" name="username" placeholder="Ingrese el sexo"/>
                </div>
        </div>
        ...
        <div class="form-group">
            <label for="password">Direccion</label>
                <div class="input-group">                   
                    <input type="text" class="form-control" id="direccion" name="username" placeholder="Ingrese la direccion"/>
                </div>
        </div>
        ...
        <div class="form-group">
            <label for="password">Codigo</label>
                <div class="input-group">                   
                    <input type="text" class="form-control" id="codigo" name="username" placeholder="Ingrese el codigo"/>
                </div>
        </div>
...
function crearEncuestado(){
    Swal.fire({
        ...
        <div class = "form-group">
            <label for="name">Nombres</label>
            <div class="input-group">
                <input type="text" class="form-control" name="name" id="nombres" placeholder="Ingrese los nombres"/>
            </div>
        </div>
        <div class="form-group">
            <label for="name">Apellidos</label>
            <div class="input-group">
                <input type="text" class="form-control" name="name" id="apellidos" placeholder="Ingrese los apellidos"/>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="input-group">   
                <input type="text" class="form-control" id="nivelEducativo" name="username" placeholder="Ingrese el nivel Educativo"/>
            </div>
        </div>
        `,
        showDenyButton: true,
...
function crearTipoPregunta(){
    Swal.fire({
        ...
        <div class="form-group">
            ...
            <div class="input-group">            
                <input type="text" class="form-control" name="name" id="tipoPregunta"  placeholder="Ingrese el tipo de Pregunta"/>
            </div>
        </div>        
        `,
        showDenyButton: true,
    ...
    Swal.fire({
        ...
        <div class="form-group">
            <label for="name">enunciado</label>
                <div class="input-group">                
                <input type="text" class="form-control" name="name" id="enunciado"  placeholder="Ingrese los Nombres"/>
            </div>
        </div>
        <div class="form-group">
