...
const pregunta2=(num1,potencia)=>{
 ...
 const pregunta3=(num1,num2,num3)=>{
        num1=parseInt(prompt("escribe el numero 1"));
        num2=parseInt(prompt("escribe el numero 2"));
 ...
 const pregunta5=(num1,num2,caracter)=>{
        num1=parseInt(prompt("escribe el numero 1"));
        num2=parseInt(prompt("escribe el numero 2"));
    ...
    const pregunta1B=(nombre,apellido,edad)=>{
    ...
    const pregunta2B=(num1,num2,num3)=>{
            num1=parseInt(prompt("escribe el numero 1"));
            num2=parseInt(prompt("escribe el numero 2"));
            num3=parseInt(prompt("escribe el numero 3"));
                resultado1=num1**3
