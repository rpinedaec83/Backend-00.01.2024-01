//Algoritmo para una tienda de zapatos que tiene una promoción de descuento para 
...
//pero menor de treinta, se le otorga un 20% de descuento; y si son más treinta zapatos se otorgará 
