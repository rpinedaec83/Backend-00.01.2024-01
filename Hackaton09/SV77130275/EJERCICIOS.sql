...
/*22 Obtener el Nombre del cliente,Nombre del Proveedor,Nombre del empleado y el nombre de los
...
/*23 Mostrar el numero de ordenes de cada uno de los clientes por año,luego ordenar codigo delcliente y el año.*/
...
/*24 Contar el numero de ordenes que se han realizado por años y meses ,luego debe ser ordenado por
año y por mes.*/
...
/*25 Seleccionar el nombre de la compañía del cliente,él código de la orden de compra,la fecha de la
...
/*26 Seleccionar el nombre de la compañía del cliente, nombre del contacto, el código de la 
